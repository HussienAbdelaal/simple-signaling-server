...
wss.on("connection", ws => {
    ws.on("message", msg => {
        ...
        switch (type) {
            ...
            // 1. check if username not exists
            // 2. create new uuid and save it with connection for later use
            // 3. respond with success and send all logged in users
            // 4. notify all other users that this user is connected
            case "login":
                ...
                break;
            case "offer":
                //if User exists then send him offer details
